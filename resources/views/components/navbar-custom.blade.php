            ...
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <div class="flex items-center">
                    <x-application-logo class="block h-12 w-12" />
                         ...
                         <!-- Texto "Gonzalez" visible en pantallas sm y superiores -->
                    <span class="self-center text-xl font-semibold hidden sm:inline whitespace-nowrap">Gonzalez</span>
                </div>
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="trigger">
                                <button>
                                    <div class="space-y-6">
                                        <div>
                                            <img data-tooltip-target="tooltip-jese" class="w-10 h-10 p-1 rounded-full ring-2 ring-green-500" src="{{ Auth::user()->profile_photo_url }}" alt="Avatar">
                                        </div>
                                    </div>
                                </button>
                            </x-slot>
